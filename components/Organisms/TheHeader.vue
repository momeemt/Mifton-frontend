<template>
  <div id="common-header" :class="pageType">
    <div class="group">
      ...
      <nuxt-link v-if="isLoggedIn" to="/home">Mifton</nuxt-link>
      <nuxt-link v-else to="/">Mifton</nuxt-link>
    </div>
    <div class="group">
      <i class="fas fa-user-friends"></i>
      <nuxt-link v-if="isLoggedIn" to="/bector/home">Bector</nuxt-link>
      <nuxt-link v-else to="/bector/">Bector</nuxt-link>
    </div>
    <div class="group">
